...
write.csv(works_df, "ORCID_works.csv", row.names = F)
...
write.csv(ed_df, "ORCID_ed.csv", row.names = F)
...
write.csv(job_df, "ORCID_job.csv", row.names = F)
```
...
write.csv(works_df, "scholar_works.csv", row.names = F)
...
write.csv(info_df, "scholar_info.csv", row.names = F)
```
