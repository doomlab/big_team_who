...
-   Research Question 1: Using current publication values, what should define big team science versus team science? (and change across time)
...
### RQ3: Author Descriptive Statistics
...
For each author, we calculated the number of publications and the h-index. The h-index represents the highest *h* number of publications that have at least *h* citations.
