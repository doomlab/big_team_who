...
abstract: |
  ...
  Pre-registration: This manuscript was preregistered with the same conceptual ideas using Google Scholar and ORC-ID databases (https://osf.io/f2dtr) but then was updated with access to the Scopus database for a broader picture of BTS projects (https://osf.io/fheun). After review, we updated the manuscript to reflect that the definition of big team science is unclear, and focused on a data-driven definition to explore our research questions. 
