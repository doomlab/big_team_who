...
Google Scholar and ORC-ID databases (MASKED FOR REVIEW^[Unfortunately, the way we created these pre-registrations did not allow for complete anonymization required by the journal]) but then
