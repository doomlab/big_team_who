...
```{r total-authors}
total_authors <- 3047067 # only this updated
#### DAMMIT FORGOT THIS ####
...
ggplot(pub_types, aes(type, count, fill = publication_type)) + 
  ...
  theme(legend.position = "bottom") + 
  scale_fill_discrete(name = "Publication Type")
...
# CZH-
# DDR -East Germany from 1974 to 1990
# EUE  -European Union laissez-passer[6
# HVO -Upper Volta
# PCI -Pacific Islands (Trust Territory)
# ROM- Romania – From February 2002; Code changed to ROU[
# SUN  -USSR From June 2008; Transitionally reserved from September 1992; Officially assigned before being deleted
# SUX-
# TWN- Taiwan still
# UNO-
