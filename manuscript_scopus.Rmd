...
```{r fig-pub-time, include = TRUE, fig.cap="Number of big-team science publications separated by four large subject areas across years.", fig.width=10, fig.height=6}
