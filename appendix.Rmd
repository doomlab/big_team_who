...
ggsave("figure/figure_app_1.png")
```
...
***Education***. As noted in our pre-registration, we would only present this variable if we could obtain at least 50% information on the authors who publish in big team science papers. `r apa_num(24228428/25282810*100)`% of the data was not available. 
...
ggsave("figure/figure_app_3.png")
