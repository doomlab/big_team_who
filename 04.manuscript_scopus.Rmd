...
# Significance 
  ...
  science collaboration overall (sav)
  - what is collaboration
  - is it increasing 
  - globalization should help

According to the Oxford English dictionary, collaboration is two or more people working together to achieve a certain goal. Collaboration in scientific endeavors involves multiple researchers at multiple institutions to communicate and work together to advance knowledge in their chosen field. Collaboration can look differently in every project dependent on the skill sets, questions and perspectives of your collaborators. While collaboration is not new in science, the current interest of "big team science" is increasing. Big team science organizations utilize and run on collaboration to ensure that diverse populations and ideas are brought into research projects, which in turn allows for more reliability and generalizability in the results and method of the study. In regards to this project, the definitions of Big Team Science will be defined as a collaboration of ten or more authors from ten different institutions. 
Big Team Science seems to be increasing as a result of the current state of the scientific field and with the increase in technology in the world.The idea of BTS is not new, but interest is new, and globalization allows us to do BTS with projects such as PSA/CERN/Reproducibility projects. Technological advances have provided easier ways to collaborate with people who are from other universities and countries through document sharing platforms (i.e. Google, github, and Open Science Framework), video chatting platforms (i.e. as zoom, skype, microsoft teams) and messaging and data tracking platforms (i.e. Slack, Shiny app, Trello boards, when2meet, etc.). The credibility movement seems to suggest that by having both collaborations that span across the globe and subfield of psychology, age groups and education levels should help to drive psychological science in the path of better materials, reliability, generalizability and more robust sample size in a study. 

ADD STUFF ABOUT THE CREDIBILITY MOVEMENT HERE….

rise of big team science because the need for resources, replication, reproducibility, generalization (erin)
  - physics
  - biology 
  - psychology
  
metascience (erin)
  - most research is on lessons learned, why bts is useful
  - little research on who/fields has done bts
  - has the globalization of science actually impacted people other than NA and Europe 
...
We specifically expect to examine ICSR's Research Themes of inclusivity, research careers, and research globalization. As we examine these themes, it will bring new knowledge of how big team science projects impact each theme and field of study. 

The globalization of science has allowed researchers across the world to contribute to research projects, but little research has examined *who* participates in big team science projects. We see an increase in BTS but we don't know if this uptick in large scale projects has diversified the *people* involved in BTS. Is this increasing inclusivity? At what level of career are people doing BTS? Is that changing over time? And how is that including new and varied researchers outside NA and Europe? Are we including people in positions that may impact their career? WEIRD thing is innovative

  
# Potential Outlets 

We will aim for high impact broad scope journals such as *Science*, *Nature* or *Nature Human Behaviour*. Other journals would include review publications within psychology to compare the social sciences to other sciences: *Perspectives in Psychological Science*, *Psychological Bulletin*, *Psychological Review*, or *Current Directions in Psychological Science*. 
...
- definition for big team size: 10 authors + at least 10 different institutions
- we will use all categories but break into the big four: https://service.elsevier.com/app/answers/detail/a_id/14882/supporthub/scopus/~/what-are-the-most-frequent-subject-area-categories-and-classifications-used-in/ 
...
journal information we could include:
  - total number of articles overall 
  - number of distinct journals in each of the four areas 
  - JIF df_sources, snip
...
- keywords are easier now - could use the ASJC smaller subfield areas to create a list 
...
- here we would pull all author ids and then grab all their papers - grab from the whole dataset not just 1970  
...
- can't get this part really - we could get institution from publication and country from publication 
...
The classification of the publication, which may be: ab Abstract Report, ar Article, ip Article in Press, bk Book, bz Business Article, ch Book Chapter, cp Conference Paper, cr Conference Review, dp Data paper, ed Editorial, er Erratum, le Letter, no Note, pp Preprint, pr Press Release, rp Report, re Review, sh Survey, tb Retracted.
...
- so we cant do MLM 
- for each paper we could calculate an average career length, then run the regression 
- then calculate the standard deviation and do the same analysis as described 
...
same idea average down by paper for mean and standard deviation 
...
- may not need to do this random sample thing if we have large enough datasets? 
- pool them together and then compare? 
- maybe group them in the sizes we are interested in, then convert to proportions
- average those proportions ? plot comparisons of the proportions and confidence intervals for each group 
