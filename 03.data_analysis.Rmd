...
- grab the first X authors and the last authors
- compare to random samples of other authors of the same size chunk 
- calculate the probability of having *anyone* from a un region in that chunk
- make two graphs one of probability of being in the first group, one of probability of being in second group
