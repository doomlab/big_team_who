...
```{r}
table(bibs$JOURNAL)
table(bibs$KEYWORDS) # hand code 

#### impact factor grab them now #### 
```
...
- credit contributions ? are we using de-weirding by using those people for translation and data collection only 
  ...
  - employment_summary_organization_address_country (for the weird part)
  - average career length / publication counts 
- across time 
  - more varied across time
  - more people 
  - more different types of people - education levels, jobs levels, country
  - more citation style things - are people publishing more who are on these teams and what indices do they have 
