...
**_Types of Publications_**. We will summarize the coded types of publications for individuals and demonstrate the changes in types of publications over time visually. We will comment if more "open" type publications appear to be published, such as data-sets, preprints, and software. 
