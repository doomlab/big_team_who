...
Last, we will examine the effect sizes of the UN Sub-Regions represented for each year of analysis. We will present a visualization of the effect sizes. 

- add a quick random demo of this simulating fake data
- create a picture of this idea 

**All models will also include a measure of effect size.**
#### erin you need to do this #####
